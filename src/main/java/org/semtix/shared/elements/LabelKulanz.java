...
/**
 * Formularkomponente: Zeigt im PersonFormular neben dem Namen mit dem Buchstaben "K" in einem 
 * farbigen Käschen an, ob für diese Person Kulanz gesetzt ist.
 *
 */
@SuppressWarnings("serial")
public class LabelKulanz
extends JLabel {
	
	/**
	 * Erstellt ein neues LabelKulanz
	 */
	public LabelKulanz(){
        ...
        setBackground(new Color(230, 32, 32));
        setOpaque(true);
